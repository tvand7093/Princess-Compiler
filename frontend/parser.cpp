...
namespace PL {
#line 159 "parser.cpp" // lalr1.cc:479
  ...
  std::string
   PrincessParser ::yytnamerr_ (const char *yystr)
  {
    if (*yystr == '"')
      {
        std::string yyr = "";
  ...
  /// Build a parser object.
   PrincessParser :: PrincessParser  (class Driver& driver_yyarg)
    :
#if YYDEBUG
      yydebug_ (false),
      yycdebug_ (&std::cerr),
  ...
  inline
   PrincessParser ::syntax_error::syntax_error (const location_type& l, const std::string& m)
    : std::runtime_error (m)
    , location (l)
  {}
  ...
  inline
   PrincessParser ::basic_symbol<Base>::basic_symbol ()
    : value ()
  {}

  template <typename Base>
  inline
   PrincessParser ::basic_symbol<Base>::basic_symbol (const basic_symbol& other)
    : Base (other)
    , value ()
  ...
  template <typename Base>
  inline
   PrincessParser ::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const semantic_type& v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  template <typename Base>
  inline
   PrincessParser ::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const location_type& l)
    : Base (t)
    , value ()
    , location (l)
  {}
  ...
  inline
  void
   PrincessParser ::basic_symbol<Base>::clear ()
  {
    Base::clear ();
  }
  ...
  inline
  bool
   PrincessParser ::basic_symbol<Base>::empty () const
  {
  ...
  inline
  void
   PrincessParser ::basic_symbol<Base>::move (basic_symbol& s)
  {
    super_type::move(s);
    value = s.value;
    location = s.location;
  ...
  // by_type.
  inline
   PrincessParser ::by_type::by_type ()
    : type (empty_symbol)
  {}

  inline
   PrincessParser ::by_type::by_type (const by_type& other)
    : type (other.type)
  {}

  inline
   PrincessParser ::by_type::by_type (token_type t)
    : type (yytranslate_ (t))
  {}

  inline
  void
   PrincessParser ::by_type::clear ()
  {
    type = empty_symbol;
  }
  ...
  inline
  void
   PrincessParser ::by_type::move (by_type& that)
  {
    type = that.type;
    that.clear ();
  }
  ...
  inline
  int
   PrincessParser ::by_type::type_get () const
  {
    return type;
  }
  ...
  // by_state.
  inline
   PrincessParser ::by_state::by_state ()
    : state (empty_state)
  {}

  inline
   PrincessParser ::by_state::by_state (const by_state& other)
    : state (other.state)
  {}

  inline
  void
   PrincessParser ::by_state::clear ()
  {
    state = empty_state;
  }
  ...
  inline
  void
   PrincessParser ::by_state::move (by_state& that)
  {
    state = that.state;
    that.clear ();
  }
  ...
  inline
   PrincessParser ::by_state::by_state (state_type s)
    : state (s)
  {}

  inline
   PrincessParser ::symbol_number_type
   PrincessParser ::by_state::type_get () const
  {
  ...
  inline
   PrincessParser ::stack_symbol_type::stack_symbol_type ()
  {}


  inline
   PrincessParser ::stack_symbol_type::stack_symbol_type (state_type s, symbol_type& that)
  ...
  inline
   PrincessParser ::stack_symbol_type&
   PrincessParser ::stack_symbol_type::operator= (const stack_symbol_type& that)
  {
    state = that.state;
    value = that.value;
  ...
  inline
  void
   PrincessParser ::yy_destroy_ (const char* yymsg, basic_symbol<Base>& yysym) const
  {
    if (yymsg)
...
#line 71 "parser.yy" // lalr1.cc:617
        { delete (yysym.value.stringVal); }
#line 412 "parser.cpp" // lalr1.cc:617
        break;
...
#line 419 "parser.cpp" // lalr1.cc:617
        break;
...
#line 72 "parser.yy" // lalr1.cc:617
        { delete (yysym.value.calcnode); }
#line 426 "parser.cpp" // lalr1.cc:617
        break;
...
#line 73 "parser.yy" // lalr1.cc:617
        { delete (yysym.value.calcnode); }
#line 433 "parser.cpp" // lalr1.cc:617
        break;
...
#line 73 "parser.yy" // lalr1.cc:617
        { delete (yysym.value.calcnode); }
#line 440 "parser.cpp" // lalr1.cc:617
        break;
...
#line 73 "parser.yy" // lalr1.cc:617
        { delete (yysym.value.calcnode); }
#line 447 "parser.cpp" // lalr1.cc:617
        break;
...
#line 73 "parser.yy" // lalr1.cc:617
        { delete (yysym.value.calcnode); }
#line 454 "parser.cpp" // lalr1.cc:617
        break;
...
#line 73 "parser.yy" // lalr1.cc:617
        { delete (yysym.value.calcnode); }
#line 461 "parser.cpp" // lalr1.cc:617
        break;
...
#line 73 "parser.yy" // lalr1.cc:617
        { delete (yysym.value.calcnode); }
#line 468 "parser.cpp" // lalr1.cc:617
        break;
  ...
  template <typename Base>
  void
   PrincessParser ::yy_print_ (std::ostream& yyo,
  ...
  inline
  void
   PrincessParser ::yypush_ (const char* m, state_type s, symbol_type& sym)
  {
  ...
  inline
  void
   PrincessParser ::yypush_ (const char* m, stack_symbol_type& s)
  {
    if (m)
      YY_SYMBOL_PRINT (m, s);
    yystack_.push (s);
  ...
  inline
  void
   PrincessParser ::yypop_ (unsigned int n)
  {
    yystack_.pop (n);
  }
...
#if YYDEBUG
  std::ostream&
   PrincessParser ::debug_stream () const
  {
    return *yycdebug_;
  }

  void
   PrincessParser ::set_debug_stream (std::ostream& o)
  {
    yycdebug_ = &o;
  }


   PrincessParser ::debug_level_type
   PrincessParser ::debug_level () const
  {
    return yydebug_;
  }

  void
   PrincessParser ::set_debug_level (debug_level_type l)
  {
    yydebug_ = l;
  }
#endif // YYDEBUG

  inline  PrincessParser ::state_type
   PrincessParser ::yy_lr_goto_state_ (state_type yystate, int yysym)
  {
  ...
  inline bool
   PrincessParser ::yy_pact_value_is_default_ (int yyvalue)
  {
    return yyvalue == yypact_ninf_;
  }

  inline bool
   PrincessParser ::yy_table_value_is_error_ (int yyvalue)
  {
    return yyvalue == yytable_ninf_;
  }

  int
   PrincessParser ::parse ()
  {
    // State.
    int yyn;
    ...
    #line 40 "parser.yy" // lalr1.cc:745
{
    // initialize the initial location object
    yyla.location.begin.filename = yyla.location.end.filename = &driver.streamname;
}

#line 606 "parser.cpp" // lalr1.cc:745
...
#line 910 "parser.cpp" // lalr1.cc:859
  ...
  void
   PrincessParser ::error (const syntax_error& yyexc)
  {
  ...
  std::string
   PrincessParser ::yysyntax_error_ (state_type yystate, const symbol_type& yyla) const
  {
...
#undef YYCASE_
  ...
  const signed char  PrincessParser ::yypact_ninf_ = -9;

  const signed char  PrincessParser ::yytable_ninf_ = -1;

  const signed char
   PrincessParser ::yypact_[] =
  {
...
#if YYDEBUG
  const unsigned char
   PrincessParser ::yyrline_[] =
  {
       0,    94,    94,    98,   103,   116,   120,   124,   129,   133,
     138,   142,   146,   151,   155,   159,   163,   168,   172,   176,
     181,   186,   195,   196,   197,   198,   199,   200,   201,   205,
     209
  };

  // Print the state stack on the debug stream.
  void
   PrincessParser ::yystack_print_ ()
  {
    *yycdebug_ << "Stack now";
  ...
  void
   PrincessParser ::yy_reduce_print_ (int yyrule)
  {
  ...
  inline
   PrincessParser ::token_number_type
   PrincessParser ::yytranslate_ (int t)
  {
    static
...
#line 1354 "parser.cpp" // lalr1.cc:1167
#line 216 "parser.yy" // lalr1.cc:1168
 /*** Additional Code ***/

void PL::PrincessParser::error(const PL::PrincessParser::location_type& l,
			    const std::string& m)
{
    driver.error(l, m);
}
